...
/* ─────────────────────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────────── */
const TRADERS = [
  { id:"DEMO", name:"Alex Thornton", email:"a.thornton@gmail.com", country:"UK", signup:"10 Nov 2024", payment:"10 Nov 2024", challenge:"Phase 2", ip:"192.168.1.10", affiliate:"AFF01", accountSize:200000, pnl:15200, riskScore:82, riskLevel:"High", stage:"flagged", avatar:"AT", payoutEligibility:"Under Review", hasViolation:true, isDemo:true },
  { id:"T001", name:"Marcus Chen", email:"m.chen@gmail.com", country:"SG", signup:"01 Nov 2024", payment:"02 Nov 2024", challenge:"Phase 1", ip:"192.168.1.10", affiliate:"AFF01", accountSize:200000, pnl:18320, riskScore:12, riskLevel:"Low", stage:"active", avatar:"MC", payoutEligibility:"Eligible", hasViolation:false, isDemo:false },
  { id:"T002", name:"Priya Nair", email:"priya.n@outlook.com", country:"IN", signup:"03 Nov 2024", payment:"03 Nov 2024", challenge:"Phase 2", ip:"10.0.0.22", affiliate:"AFF02", accountSize:100000, pnl:12100, riskScore:8, riskLevel:"Low", stage:"passed", avatar:"PN", payoutEligibility:"Eligible", hasViolation:false, isDemo:false },
  { id:"T003", name:"Jordan Rivers", email:"jrivers@yahoo.com", country:"US", signup:"05 Nov 2024", payment:"06 Nov 2024", challenge:"Phase 1", ip:"172.16.0.5", affiliate:"AFF01", accountSize:100000, pnl:-8200, riskScore:45, riskLevel:"Elevated", stage:"failed", avatar:"JR", payoutEligibility:"Not Eligible", hasViolation:true, isDemo:false },
  ...
  { id:"T005", name:"Kofi Asante", email:"k.asante@proton.me", country:"GH", signup:"08 Nov 2024", payment:"08 Nov 2024", challenge:"Phase 2", ip:"203.0.113.4", affiliate:"AFF03", accountSize:400000, pnl:38400, riskScore:5, riskLevel:"Low", stage:"active", avatar:"KA", payoutEligibility:"Eligible", hasViolation:false, isDemo:false },
  { id:"T006", name:"Dmitri Volkov", email:"dvolkov@temp.io", country:"RU", signup:"09 Nov 2024", payment:"09 Nov 2024", challenge:"Phase 1", ip:"192.168.1.10", affiliate:null, accountSize:200000, pnl:-4800, riskScore:91, riskLevel:"Critical", stage:"flagged", avatar:"DV", payoutEligibility:"Under Review", hasViolation:true, isDemo:false },
  { id:"T007", name:"Amara Diallo", email:"a.diallo@gmail.com", country:"SN", signup:"10 Nov 2024", payment:"11 Nov 2024", challenge:"Phase 1", ip:"198.51.100.7", affiliate:"AFF02", accountSize:50000, pnl:3100, riskScore:18, riskLevel:"Low", stage:"active", avatar:"AD", payoutEligibility:"Not Eligible", hasViolation:false, isDemo:false },
  { id:"T008", name:"Wei Zhang", email:"wzhang@corp.com", country:"CN", signup:"11 Nov 2024", payment:"11 Nov 2024", challenge:"Phase 2", ip:"192.0.2.44", affiliate:"AFF01", accountSize:200000, pnl:24800, riskScore:3, riskLevel:"Low", stage:"passed", avatar:"WZ", payoutEligibility:"Eligible", hasViolation:false, isDemo:false },
  ...
  { id:"T010", name:"Fatima Al-Hassan", email:"f.alhassan@gmail.com", country:"AE", signup:"12 Nov 2024", payment:"12 Nov 2024", challenge:"Phase 1", ip:"10.1.1.99", affiliate:"AFF02", accountSize:100000, pnl:7200, riskScore:22, riskLevel:"Elevated", stage:"active", avatar:"FA", payoutEligibility:"Under Review", hasViolation:true, isDemo:false },
];
...
const BROKER_CLIENTS = [
  { id:"C001", name:"James Okafor", email:"j.okafor@gmail.com", country:"NG", accountType:"ECN", balance:285000, deposit:285000, openPnl:+4240, riskScore:8, riskLevel:"Low", kycStatus:"Verified", stage:"active", avatar:"JO", ibRef:"IB01", joined:"03 Jan 2024", lastTrade:"Today", flagged:false },
  { id:"C002", name:"Sarah Mitchell", email:"s.mitchell@outlook.com", country:"ZA", accountType:"Standard", balance:122000, deposit:122000, openPnl:-1340, riskScore:15, riskLevel:"Low", kycStatus:"Verified", stage:"active", avatar:"SM", ibRef:"IB02", joined:"15 Jan 2024", lastTrade:"Yesterday", flagged:false },
  { id:"C003", name:"Raj Patel", email:"raj.p@corp.com", country:"IN", accountType:"VIP", balance:780000, deposit:750000, openPnl:+14800, riskScore:22, riskLevel:"Elevated", kycStatus:"Verified", stage:"active", avatar:"RP", ibRef:null, joined:"22 Dec 2023", lastTrade:"Today", flagged:false },
  { id:"C004", name:"Chen Wei", email:"cwei@temp.biz", country:"CN", accountType:"Standard", balance:450000, deposit:450000, openPnl:0, riskScore:88, riskLevel:"Critical", kycStatus:"Failed", stage:"suspended", avatar:"CW", ibRef:"IB01", joined:"01 Feb 2024", lastTrade:"10 Feb 2024", flagged:true },
  { id:"C005", name:"Amira Hassan", email:"a.hassan@proton.me", country:"AE", accountType:"ECN", balance:195000, deposit:180000, openPnl:+6200, riskScore:11, riskLevel:"Low", kycStatus:"Verified", stage:"active", avatar:"AH", ibRef:"IB03", joined:"10 Feb 2024", lastTrade:"Today", flagged:false },
  ...
  { id:"C007", name:"Nomsa Dlamini", email:"n.dlamini@gmail.com", country:"ZA", accountType:"Standard", balance:58500, deposit:58500, openPnl:+1180, riskScore:6, riskLevel:"Low", kycStatus:"Verified", stage:"active", avatar:"ND", ibRef:"IB02", joined:"20 Mar 2024", lastTrade:"2 days ago", flagged:false },
  { id:"C008", name:"Ahmed Al-Farsi", email:"ahmed.af@gmail.com", country:"AE", accountType:"VIP", balance:1250000, deposit:1200000, openPnl:+32400, riskScore:14, riskLevel:"Low", kycStatus:"Verified", stage:"active", avatar:"AA", ibRef:null, joined:"05 Apr 2024", lastTrade:"Today", flagged:false },
  { id:"C009", name:"Lena Kovac", email:"lkovac@hotmail.com", country:"HR", accountType:"ECN", balance:131000, deposit:130000, openPnl:+2290, riskScore:9, riskLevel:"Low", kycStatus:"Verified", stage:"active", avatar:"LK", ibRef:"IB03", joined:"12 Apr 2024", lastTrade:"Today", flagged:false },
  { id:"C010", name:"Tunde Adeyemi", email:"t.adeyemi@yahoo.com", country:"NG", accountType:"Standard", balance:68000, deposit:70000, openPnl:-2820, riskScore:44, riskLevel:"Elevated", kycStatus:"Pending", stage:"active", avatar:"TA", ibRef:"IB01", joined:"18 Apr 2024", lastTrade:"Yesterday", flagged:true },
];
...
const $k = (n) => n >= 1000000 ? `$${(n/1000000).toFixed(2)}M` : n >= 1000 ? `$${(n/1000).toFixed(1)}k` : $(n);
